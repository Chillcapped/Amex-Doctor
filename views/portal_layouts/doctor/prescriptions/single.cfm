...
<div id="contentContainer">
	<h4>Bulk Prescribe - Select Patients</h4>
  ...
  <div id="content" class="bulkOrderContent">
      <p>Patients with active prescriptions:</p>
			<div id="boContainer">
				<form action="/prescribe/bulkpreview" method="post" id="bulkOrderForm">
					<div id="boPatients">
						<div id="boAmexPatients">
								<ul>
									<cfloop from="1" to="#arrayLen(patientLookup.patients)#" index="i">
											<cfoutput>
										<li class="patientBoxListItem"><input type="checkbox" id="#patientLookup.patients[i]['_source'].patientID#" name="pt:#patientLookup.patients[i]['_source'].patientID#">
