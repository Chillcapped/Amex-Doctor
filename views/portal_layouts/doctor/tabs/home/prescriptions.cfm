<cfinvoke component="api.doctor" method="getDoctorsPrescriptions" returnVariable="doctorsRx">
	...
	<cfinvokeargument name="filterBy" value="#application.rxStatus['Authorized'].statusID#">
</cfinvoke>
		...
		<tbody>
			...
			<cfloop from="1" to="#arrayLen(doctorsRx.prescriptions)#" index="i">
				...
				<tr>
					...
					<td><a href="javascript:showPrescriptionInfo('#doctorsRx.prescriptions[i].erxID#');">#doctorsRx.prescriptions[i].rxID#</td></a>
					...
					<td><a href="javascript:showPrescriptionInfo('#doctorsRx.prescriptions[i].erxID#');">#application.rxStatusIDLookup[doctorsRx.prescriptions[i].status].name#</a></td>
			...
			<cfloop from="1" to="#arrayLen(doctorsRx.prescriptions)#" index="i">
				...
				<tr>
					...
					<td><a href="javascript:showPrescriptionInfo('#eRx#');">#doctorsRx.prescriptions[i]['_source'].rxID#</td></a>
